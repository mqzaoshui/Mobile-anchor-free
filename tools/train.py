...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--conf-file', default='./configs/yolov6t.py', type=str, help='experiments description file')
    parser.add_argument('--img-size', default=640, type=int, help='train, val image size (pixels)')
    parser.add_argument('--batch-size', default=64, type=int, help='total batch size for all GPUs')
    ...
    parser.add_argument('--output-dir', default='./runs-v6-t/train', type=str, help='path to save outputs')
    ...
    parser.add_argument('--pretrain_model_path', type=str, default=None, help='pre-train model path')
