...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--project', default='test/inference', help='save inference results to project/name.')
    ...
    parser.add_argument('--vit',action='store_true',help='whether to use letter_box to modify the img-size for mobilevit model')
...
def run(weights=osp.join(ROOT, 'yolov6s.pt'),
    ...
    # Inference
    inferer = Inferer(source, weights, device, yaml, img_size, half, vit)
